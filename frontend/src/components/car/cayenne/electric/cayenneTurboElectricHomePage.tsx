...
import CayenneElectricTechnicalData from './cayenneElectricTechnicalData';
import VideoCard from '@/components/common/VideoCard';
import { X } from 'lucide-react';
import { useState } from 'react';

const CayenneTurboElectricHomePage = () => {
    const [menuOpen, setMenuOpen] = useState(false);
    const modelId = "cayenne";
    const variantId = "electric";
    const carId = "cayenne-turbo-electric";
               ...
               <div className='max-w-7xl px-3 mx-auto'>
                ...
                >
                    ...
                    <div className="px-4 py-6 sm:px-8 lg:px-10">
                        <CayenneElectricTechnicalData technicalData={car.technical_data} />
                    </div>
                </aside>
            </div>
...
export default CayenneTurboElectricHomePage;