        ...
        <section className=" bg-[#131212] text-white">
            ...
            <div className="mx-auto max-w-7xl px-6 py-20 md:px-10 lg:px-16">
                ...
                <div className="p-4 text-white flex gap-5 ">
                    <div className="flex flex-col gap-4 md:gap-4 rounded-2xl">
                    ...
                    <div className="w-1/2">
                        <div className="grid grid-cols-1 gap-3 rounded-xl mt-4 w-full">
                            {[
                        ...
                        <div className="mt-4 space-y-2 text-sm">
                            ...
                            <div className="flex justify-between items-center">
                                ...
                                <div className="flex gap-1 items-center">
                                    <p>
                                        {terrainFeatures?.slopeAngle?.steelSuspension?.front?.value} / {terrainFeatures?.slopeAngle?.steelSuspension?.rear?.value}
                                    </p>
                                    <span>{terrainFeatures?.slopeAngle?.steelSuspension?.front?.unit}</span>
                                </div>
                            </div>
                ...
                <div className="max-w-5xl">
                    ...
                    <div id="charging" className="mt-6 ">
                        ...
                        <button
                            type="button"
                            className="flex w-full border-b border-white/10 pb-4 cursor-pointer items-center justify-between text-left focus:outline-none"
