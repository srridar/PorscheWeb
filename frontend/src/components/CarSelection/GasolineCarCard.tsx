      ...
      <div className="p-6">
        ...
        <div className="grid grid-cols-3  py-5">
          ...
          <div className=" border-gray-200 px-4">
            ...
            <p className="mt-1 text-lg font-semibold text-gray-300">
              {car.maxTorque?.value}
              <span className="ml-1 text-xs font-normal text-gray-500"> {car.maxTorque?.unit} </span>
            </p>
          </div>
          ...
          <div className="pl-4">
            ...
            <p className="mt-1 text-lg font-semibold text-gray-300">
              {car.topSpeed.value}
              <span className="ml-1 text-xs font-normal text-gray-500">{car.topSpeed.unit}</span>
            </p>
          </div>
        ...
        {car.powerElectricMotor && (
          <div >
            <div className=" flex justify-between items-center pr-4">
              <p className="text-xs tracking-wider text-gray-400">  Power Electric Motor </p>
              <p className=" text-xs font-semibold text-gray-300"> {car.powerElectricMotor?.kW} kw </p>
            </div>

            <div className=" flex justify-between items-center pr-4 ">
              <p className="text-xs  tracking-wider text-gray-400">  Power Combined </p>
              <p className="mt-1 text-xs font-semibold text-gray-300"> {car.powerCombined?.kW} kw </p>
            </div>
          </div>
        )
        }
